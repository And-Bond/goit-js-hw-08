...
var _galleryCollectionCreate = require("./js/gallery-collection-create");
var _galleryCollectionCreateDefault = parcelHelpers.interopDefault(_galleryCollectionCreate);
// const galleryItems = [
//   {
//     preview:
...
refs.galleryBox.insertAdjacentHTML("beforeend", (0, _galleryCollectionCreateDefault.default));
...
},{"./js/gallery-collection-create":"gtGI4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gtGI4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createGalleryCollection(galleryItems1) {
    return galleryItems1.map(({ preview , original , description  })=>{
        return `<li class="gallery__item">
       <a
         class="gallery__link"
         href="#"
...
exports.default = galleryResult = createGalleryCollection(galleryItems);
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequired4d9")
