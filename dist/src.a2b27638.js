...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/gallery-collection-create.js":[function(require,module,exports) {
"use strict";
...
var galleryResult = createGalleryCollection(galleryItems);
var _default = galleryResult;
...
refs.galleryBox.insertAdjacentHTML("beforeend", _galleryCollectionCreate.default);
...
function onGalleryClick(evt) {
  ...
  var currentImage = document.querySelector('img.lightbox__image');
